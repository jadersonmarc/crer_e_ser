...
export interface ApiMinistrieMinistrie extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    description: Attribute.Text;
    established_date: Attribute.Date;
    head_of_ministry: Attribute.String;
    contact_email: Attribute.Email;
    contact_phone: Attribute.BigInteger;
    users: Attribute.Relation<
      'api::ministrie.ministrie',
      'manyToMany',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::ministrie.ministrie': ApiMinistrieMinistrie;
